package com.example.lugaresrealtime;
...
import com.example.lugaresrealtime.ml.LugarModel;
...
public class MainActivity extends AppCompatActivity implements OnSuccessListener<Text>,
    ...
    public void PersonalizedModel(View v) {
        try {
            LugarModel model =  LugarModel.newInstance(getApplicationContext());
            TensorImage image = TensorImage.fromBitmap(mSelectedImage);

            LugarModel.Outputs outputs = model.process(image);
